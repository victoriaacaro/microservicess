...
// Importa las rutas de productos desde el archivo productRoutes
const productRoutes = require('./routes/productRoutes');

// Crea una instancia de la aplicación express
const app = express();

// Define el puerto en el que correrá el servidor, usando una variable de entorno o el puerto 3001 por defecto
...
// Monta las rutas de productos en la ruta base /api/products
...
// productRoutes: Contiene las rutas relacionadas con los productos.
...
// app.use('/api/products', productRoutes): Monta las rutas de productos en la ruta base /api/products.
// app.listen: Inicia el servidor y lo hace escuchar en el puerto definido (3001 por defecto).

// Este archivo es el punto de entrada del microservicio de catálogo y configura la aplicación para 
// manejar solicitudes relacionadas con los productos. 